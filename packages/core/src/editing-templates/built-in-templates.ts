...
export const BUILT_IN_EDITING_TEMPLATES: readonly EditingTemplate[] = [
  ...
  },
  {
    ...
    supportedTargets: ["video", "image"],
    controls: [
      { id: "watermarkText", label: "Watermark", type: "text", defaultValue: "AI-Video-Stitching-Pipeline" },
  ...
  },
  {
    ...
    supportedTargets: ["video", "image"],
    controls: [
      { id: "name", label: "Name", type: "text", defaultValue: "AI-Video-Stitching-Pipeline" },
  ...
  },
  {
    ...
    supportedTargets: ["video", "image"],
    controls: [
      { id: "tags", label: "Hashtags", type: "text", defaultValue: "#aiVideoStitching #editing #carSales" },
    ],
    recipe: {
      effects: [],
      overlays: [
